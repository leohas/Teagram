...
function scene:create( event )
		...
		print("tutorialNivel8 Create Function")
...
----------------------------------------------------------------------------------------------------------------------
		...
		quadrado_vermelho = display.newImageRect(groupFore,"images/figuras/quadrado_vermelho.png", 84.59, 84.59)
    quadrado_vermelho.x = display.contentCenterX + 210
		quadrado_vermelho.y = display.contentCenterY
		quadrado_vermelho.alpha = 0.3
		quadrado_vermelho:setFillColor(0,0,0)

		trapezio_rosa = display.newImageRect(groupFore,"images/figuras/trapezio_rosa.png", 161.16, 81.12)
    trapezio_rosa.x = display.contentCenterX + 105
		trapezio_rosa.y = display.contentCenterY + 75
		trapezio_rosa.alpha = 0.3
		trapezio_rosa:setFillColor(0,0,0)

		pentagono_azul = display.newImageRect(groupFore,"images/figuras/pentagono_azul.png", 124.99, 118.05)
    pentagono_azul.x = display.contentCenterX + 95
		pentagono_azul.y = display.contentCenterY - 75
		pentagono_azul.alpha = 0.3
		pentagono_azul:setFillColor(0,0,0)
------------------------------------------------------------------------------------------------------------------------
		--Criando peças soltas e colocando no grupo do Foreground
  	quadrado_vermelho = display.newImageRect(groupFore,"images/figuras/quadrado_vermelho.png", 84.59, 84.59)
    quadrado_vermelho.x = display.contentCenterX - 110
		quadrado_vermelho.y = display.contentCenterY + 16
		quadrado_vermelho:addEventListener("touch", OnTouch)
		
		trapezio_rosa = display.newImageRect(groupFore,"images/figuras/trapezio_rosa.png", 161.16, 81.12)
    trapezio_rosa.x = display.contentCenterX - 195
		trapezio_rosa.y = display.contentCenterY + 110
		trapezio_rosa:addEventListener("touch", OnTouch)

		pentagono_azul = display.newImageRect(groupFore,"images/figuras/pentagono_azul.png", 124.99, 118.05)
    pentagono_azul.x = display.contentCenterX - 210
		pentagono_azul.y = display.contentCenterY - 95
		pentagono_azul:addEventListener("touch", OnTouch)		
end
-- Função show()
--[[
...
function scene:show( event )
    local sceneGroup = self.view
		...
		print("tutorialNivel8 Show Function")

		if ( phase == "will" ) then
			print("tutorialNivel8 Show Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel8 Show Phase Did")
    end
end
...
function scene:hide( event )
    ...
    local phase = event.phase
		...
		print("tutorialNivel8 Hide Function")

		if ( phase == "will" ) then
			print("tutorialNivel8 Hide Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel8 Hide Phase Did")
		end	
end
...
function scene:destroy( event )
	print("tutorialNivel8 Destroy Function")

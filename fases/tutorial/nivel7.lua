...
function scene:create( event )
		...
		print("tutorialNivel7 Create Function")
...
----------------------------------------------------------------------------------------------------------------------
    ...
    retangulo_roxo.x = display.contentCenterX + 174
		retangulo_roxo.y = display.contentCenterY - 95
		retangulo_roxo.alpha = 0.3
		retangulo_roxo:setFillColor(0,0,0)
    ...
    circulo_verde.x = display.contentCenterX + 85
		circulo_verde.y = display.contentCenterY + 10
		circulo_verde.alpha = 0.3
		circulo_verde:setFillColor(0,0,0)	
    ...
    triangulo_amarelo.x = display.contentCenterX + 200
		triangulo_amarelo.y = display.contentCenterY + 60
...
function scene:show( event )
    local sceneGroup = self.view
		...
		print("tutorialNivel7 Show Function")

		if ( phase == "will" ) then
			print("tutorialNivel7 Show Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel7 Show Phase Did")
    end
end
...
function scene:hide( event )
    ...
    local phase = event.phase
		...
		print("tutorialNivel7 Hide Function")

		if ( phase == "will" ) then
			print("tutorialNivel7 Hide Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel7 Hide Phase Did")
		end	
end
...
function scene:destroy( event )
	print("tutorialNivel7 Destroy Function")

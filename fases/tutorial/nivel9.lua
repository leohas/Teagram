...
function scene:create( event )
		...
		print("tutorialNivel9 Create Function")
...
----------------------------------------------------------------------------------------------------------------------
    ...
    triangulo_amarelo.x = display.contentCenterX + 210
		triangulo_amarelo.y = display.contentCenterY + 10
		triangulo_amarelo.alpha = 0.3
		triangulo_amarelo:setFillColor(0,0,0)

		triangulo_verde = display.newImageRect(groupFore,"images/figuras/triangulo_verde.png", 128.49, 110.44)
    triangulo_verde.x = display.contentCenterX + 105
		triangulo_verde.y = display.contentCenterY + 80
		triangulo_verde.alpha = 0.3
		triangulo_verde:setFillColor(0,0,0)
------------------------------------------------------------------------------------------------------------------------
		--Criando peças soltas e colocando no grupo do Foreground
  	pentagono_azul = display.newImageRect(groupFore,"images/figuras/pentagono_azul.png", 124.99, 118.05)
    pentagono_azul.x = display.contentCenterX - 135
...
function scene:show( event )
    local sceneGroup = self.view
		...
		print("tutorialNivel9 Show Function")

		if ( phase == "will" ) then
			print("tutorialNivel9 Show Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel9 Show Phase Did")
    end
end
...
function scene:hide( event )
    ...
    local phase = event.phase
		...
		print("tutorialNivel9 Hide Function")

		if ( phase == "will" ) then
			print("tutorialNivel9 Hide Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel9 Hide Phase Did")
		end	
end
...
function scene:destroy( event )
	print("tutorialNivel9 Destroy Function")

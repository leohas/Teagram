...
function scene:create( event )
		...
		print("tutorialNivel10 Create Function")
...
function scene:show( event )
    local sceneGroup = self.view
		...
		print("tutorialNivel10 Show Function")

		if ( phase == "will" ) then
			print("tutorialNivel10 Show Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel10 Show Phase Did")
    end
end
...
function scene:hide( event )
    ...
    local phase = event.phase
		...
		print("tutorialNivel10 Hide Function")

		if ( phase == "will" ) then
			print("tutorialNivel10 Hide Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel10 Hide Phase Did")
		end	
end
...
function scene:destroy( event )
	print("tutorialNivel10 Destroy Function")

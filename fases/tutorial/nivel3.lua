...
function scene:create( event )
		...
		print("tutorialNivel3 Create Function")
...
----------------------------------------------------------------------------------------------------------------------
		...
		quadrado_vermelho = display.newImageRect(groupFore,"images/figuras/quadrado_vermelho.png", 104.59, 104.59)
    quadrado_vermelho.x = display.contentCenterX + 185
		quadrado_vermelho.y = display.contentCenterY - 80
		quadrado_vermelho.alpha = 0.3
  
		circulo_verde = display.newImageRect(groupFore,"images/figuras/circulo_verde.png", 122.46, 122.46)
    circulo_verde.x = display.contentCenterX + 85
		circulo_verde.y = display.contentCenterY + 50
		circulo_verde.alpha = 0.3

		triangulo_amarelo = display.newImageRect(groupFore,"images/figuras/triangulo_isosceles_amarelo.png", 123.49, 105.44)
...
------------------------------------------------------------------------------------------------------------------------
    ...
    quadrado_vermelho.x = display.contentCenterX - 185
		...
		circulo_verde = display.newImageRect(groupFore,"images/figuras/circulo_verde.png", 122.46, 122.46)
    circulo_verde.x = display.contentCenterX - 105
		circulo_verde.y = display.contentCenterY + 50
		circulo_verde:addEventListener("touch", OnTouch)

		triangulo_amarelo = display.newImageRect(groupFore,"images/figuras/triangulo_isosceles_amarelo.png", 123.49, 105.44)
    triangulo_amarelo.x = display.contentCenterX - 215
		triangulo_amarelo.y = display.contentCenterY + 90
...
function scene:show( event )
    local sceneGroup = self.view
		...
		print("tutorialNivel3 Show Function")

		if ( phase == "will" ) then
			print("tutorialNivel3 Show Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel3 Show Phase Did")
    end
end
...
function scene:hide( event )
    ...
    local phase = event.phase
		...
		print("tutorialNivel3 Hide Function")

		if ( phase == "will" ) then
			print("tutorialNivel3 Hide Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel3 Hide Phase Did")
		end	
end
...
function scene:destroy( event )
	print("tutorialNivel3 Destroy Function")

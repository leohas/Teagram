...
function scene:create( event )
		...
		print("tutorialNivel1 Create Function")
...
----------------------------------------------------------------------------------------------------------------------
		...
		quadrado_vermelho = display.newImageRect(groupFore,"images/figuras/quadrado_vermelho.png", 133.49,133.49)
    quadrado_vermelho.x = display.contentCenterX + 130
		quadrado_vermelho.y = display.contentCenterY - 10
...
function scene:show( event )
    local sceneGroup = self.view
		...
		print("tutorialNivel1 Show Function")

		if ( phase == "will" ) then
			print("tutorialNivel1 Show Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel1 Show Phase Did")
    end
end
...
function scene:hide( event )
    ...
    local phase = event.phase
		...
		print("tutorialNivel1 Hide Function")

		if ( phase == "will" ) then
			print("tutorialNivel1 Hide Phase Will")
		elseif ( phase == "did" ) then
			print("tutorialNivel1 Hide Phase Did")
		end	
end
...
function scene:destroy( event )
	print("tutorialNivel1 Destroy Function")

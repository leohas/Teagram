...
----------------------------------------------------------------------------------------------------------------------
		...
		retangulo_verde_encaixe = display.newImage("images/figuras/retangulo_verde_bordado1.png")
		groupCat:insert(retangulo_verde_encaixe)
		retangulo_verde_encaixe.name = 'retangulo_verde'
		retangulo_verde_encaixe.x = display.contentCenterX + 568
		retangulo_verde_encaixe.y = display.contentCenterY + 257.5

		triangulo_amarelo_encaixe = display.newImage("images/figuras/triangulo_amarelo_bordado1.png")
		...
		triangulo_amarelo_encaixe.y = display.contentCenterY + 69

		triangulo_rosa_encaixe = display.newImage("images/figuras/triangulo_rosa_bordado1.png")
    ...
    triangulo_rosa_encaixe.y = display.contentCenterY - 260
		...
		triangulo_laranja_encaixe = display.newImage("images/figuras/triangulo_laranja_bordado1.png")
    ...
    triangulo_laranja_encaixe.y = display.contentCenterY - 260
		...
		losango_roxo_encaixe = display.newImage("images/figuras/losango_roxo_bordado1.png")
    ...
    losango_roxo_encaixe.y = display.contentCenterY - 155
		...
		triangulo_vermelho_encaixe = display.newImage("images/figuras/triangulo_vermelho_bordado1.png")
		...
		triangulo_azul_encaixe = display.newImage("images/figuras/triangulo_azul_bordado1.png")

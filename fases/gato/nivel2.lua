...
----------------------------------------------------------------------------------------------------------------------
		...
		triangulo_laranja_encaixe = display.newImageRect(groupCat,"images/figuras/triangulo_laranja_bordado.png", 33.7, 74  )
		triangulo_laranja_encaixe.x = display.contentCenterX + 107
		triangulo_laranja_encaixe.y = display.contentCenterY - 115

		losango_roxo_encaixe = display.newImageRect(groupCat,"images/figuras/losango_roxo_bordado.png", 69.5 , 75   )
		...
		triangulo_azul_encaixe = display.newImageRect(groupCat,"images/figuras/triangulo_azul_bordado.png", 49.1, 104.6  )
